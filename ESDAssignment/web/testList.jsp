...
<html>
    ...
    <body>
        ...
        <form action="cartController" method="POST">
            ...
            <tr><td>Muffuleta<input type="hidden" name="modelNo" value="Muffuleta"></td><td>$20<input type="hidden" name="price" value="20">
        ...
        <form action="CartController.java" method="POST">
            <tr><td>Veggie Delight<input type="hidden" name="modelNo" value="Veggie Delight"></td><td>$40<input type="hidden" name="price" value="40">
                <input type="hidden" name="quantity" value="1"><input type="hidden" name="description" value="ABC"></td><td>
            <input type="hidden" name="action" value="add"><input type="submit" name="addToCart" value="Add To Cart"></td>
        </tr>  
        </form>
         <form action="CartController.java" method="POST">
            <tr><td>Margherita<input type="hidden" name="modelNo" value="Margherita"></td><td>$10<input type="hidden" name="price" value="10">
                <input type="hidden" name="quantity" value="1"><input type="hidden" name="description" value="ABC"></td><td>
               <input type="hidden" name="action" value="add"><input type="submit" name="addToCart" value="Add To Cart"></td>
            </tr>
